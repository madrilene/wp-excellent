...
if (!function_exists('wpexcellent\the_posts_navigation')) {
	/**
	 * Print the next and previous posts navigation with custom modifications.
	 * Modify output adding ASCII arrows and class.
	 *
	 * @return void
	 */
	function the_posts_navigation()
	{
		...
		the_posts_pagination(
			array(
				'before_page_number' => esc_html__('Page', 'wpexcellent') . ' ',
				'mid_size'           => 0,
				'prev_text'          => sprintf(
					'%s <span class="nav-prev-text">%s</span>',
					is_rtl() ? '→' : '←', // ASCII arrows for RTL and LTR
					wp_kses(
						__('Newer <span class="nav-short">posts</span>', 'wpexcellent'),
						array(
							'span' => array(
								'class' => array(),
							),
				...
				'next_text'          => sprintf(
					...
					wp_kses(
						__('Older <span class="nav-short">posts</span>', 'wpexcellent'),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		$pagination = str_replace('<div class="nav-links"', '<div class="cluster"', $pagination);
