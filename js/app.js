...
(() => {
  ...
  window.addEventListener("load", function() {
    ...
    navigationToggle.addEventListener(
      ...
      function(event) {
        navIsOpen = !navIsOpen;
        navIsOpen ? (navigationToggle.querySelector("span").textContent = "Close", navigationToggle.querySelector(".menuClosedIcon").classList.add("hidden"), navigationToggle.querySelector(".menuOpenIcon").classList.remove("hidden"), navigationToggle.setAttribute("aria-expanded", "true")) : (navigationToggle.querySelector("span").textContent = "Menu", navigationToggle.querySelector(".menuClosedIcon").classList.remove("hidden"), navigationToggle.querySelector(".menuOpenIcon").classList.add("hidden"), navigationToggle.setAttribute("aria-expanded", "false"));
